...
<?php endif; ?>
        ...
        <!-- Confirm Jquery -->
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/confirm/jquery-confirm.min.css'); ?>">
...
<?php endif; ?>
        <div class="loading-overlay">
                <div class="spinner-border text-light spinner " style="height: 5rem; width: 5rem;">
